...
{
    public partial class frm_packetHistory : Form
    {
        public frm_packetHistory()
        {
            InitializeComponent();
        }

        private void frm_packetHistory_Load(object sender, EventArgs e)
        {
            ...
            command3.CommandText = "select * from bloodlog";
            connection.Open();
