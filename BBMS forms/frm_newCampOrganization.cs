...
{
    public partial class frm_newCampOrganization : Form
    {
        public frm_newCampOrganization()
        {
            InitializeComponent();
        }

        private void frm_newCampOrganization_Load(object sender, EventArgs e)
        {
            ...
            command3.CommandText = "select * from bloodcamps";
            connection.Open();
